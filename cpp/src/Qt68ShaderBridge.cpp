...
QShaderDescription::VariableType qtType(ParameterType type)
{
    ...
    switch (type) {
    case ParameterType::Float: return V::Float;
    case ParameterType::Float2: return V::Vec2;
    case ParameterType::Float3: return V::Vec3;
    case ParameterType::Float4: return V::Vec4;
    case ParameterType::Int: return V::Int;
    case ParameterType::Int2: return V::Int2;
    case ParameterType::Int3: return V::Int3;
    case ParameterType::Int4: return V::Int4;
    case ParameterType::UInt: return V::Uint;
    case ParameterType::UInt2: return V::Uint2;
    case ParameterType::UInt3: return V::Uint3;
    case ParameterType::UInt4: return V::Uint4;
    case ParameterType::Bool: return V::Bool;
    default: return V::Unknown;
    }
}

QShaderDescription makeDescription(slang::ProgramLayout* layout, const QList<ParameterDescriptor>& parameters)
{
    QShaderDescription desc;
    auto* p = QShaderDescriptionPrivate::get(&desc);
    if (!layout) return desc;
    ...
    if (block.size > 0) p->uniformBlocks.append(block);
    return desc;
}

void addCode(QShader& shader, QShader::Source source, int version, const QByteArray& bytes, const QByteArray& entry)
{
...
QShader buildQShader(QShader::Stage stage, const QString& entryPoint,
                     const QByteArray& spirv, const QByteArray& hlsl, const QByteArray& msl,
