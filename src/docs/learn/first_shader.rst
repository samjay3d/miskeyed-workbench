...
A slider edit updates uniform data. A source edit recompiles. Switching the visible
tool does not close documents or destroy the other tool session.

Next
----

Learn why those states differ in :doc:`../concepts/documents_and_bindings`.
