...
- Evaluated the USD/MaterialX authoring boundary with a reproducible UV-mapped fixture,
  ...
  sequence. No USD or MaterialX workflow is shipped by this change.
...
- Made release and trusted-main development documentation publication upload and deploy
  ...
  deployment. Release verification now checks the rendered page identity and reports
  request failures separately from stale Pages content. Pull requests remain artifact-only.
